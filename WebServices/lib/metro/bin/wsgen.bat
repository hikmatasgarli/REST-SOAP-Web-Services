...
:LAUNCH
%JAVA% %WSGEN_OPTS% -cp "%METRO_HOME%\lib\webservices-tools.jar;%METRO_HOME%\lib\jaxws-rt.jar;%METRO_HOME%\lib\jaxb-xjc.jar;%METRO_HOME%\lib\jaxb-jxc.jar;%METRO_HOME%\lib\jaxb-api.jar;%METRO_HOME%\lib\jaxb-core.jar;%METRO_HOME%\lib\jaxb-impl.jar" com.sun.tools.ws.WsGen %*
