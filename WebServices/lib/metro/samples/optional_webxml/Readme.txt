optional_webxml sample demonstrates the simplified deployment of web services using Metro RI deployment by not
...
not packaged in the deployed war. Metro runtime on deployment parses the sun-jaxws.xml and deploy
s the web service
endpoints. To support this feature, Metro runtime relies on the Servlet 3.0 dynamic registration API and hence this
