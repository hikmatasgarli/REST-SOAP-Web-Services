...
The programming model is same as the standard Metro Handlers. This sample shows the usage of MessageHandler to log the outbound and inbound messages on server and client.
