...
WS-Policy. This samples requires the support of WS-Policy 1.5 which was introdueced in Metro 2.2 RI. 

In etc/AddNumbers.wsdl, Notice the use of <wsp:PolicyReference URI="#AddNumbersBinding_WSAddressing_policy"/>
 in the binding section, Metro 2.2 supports the WS-Policy 1.5 Frameworka nd WS-Policy 1.5 Attachment.
...
Metro Runtime processes the requirements of the service and takes care putting WS-Addressing headers in the SOAP
